...
namespace Example
{
    ...
    public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        // Default value of the LeadingSymbol property
        internal const string DATAGRIDVIEWNUMERICUPDOWNCELL_defaultLeadingSymbol = "";
        // Default value of the TrailingSymbol property
        internal const string DATAGRIDVIEWNUMERICUPDOWNCELL_defaultTrailingSymbol = "";
        // Default (numeric) value of the cell
        internal const decimal DATAGRIDVIEWNUMERICUPDOWNCELL_defaultValue = 0;
        ...
        [ThreadStatic]
        private static CustomNumericUpDown paintingNumericUpDown;
        ...
        private string leadingSymbol;    // Caches the value of the LeadingSymbol property
        private string trailingSymbol;   // Caches the value of the TrailingSymbol property
        ...
        public DataGridViewNumericUpDownCell()
        {
            ...
            {
                paintingNumericUpDown = new CustomNumericUpDown();
            ...
            this.Value = DATAGRIDVIEWNUMERICUPDOWNCELL_defaultValue;
        }
        ...
        /// <summary>
        /// The LeadingSymbol property replicates the one from the CustomNumericUpDown control
        /// </summary>
        ...
        /// <summary>
        /// The TrailingSymbol property replicates the one from the CustomNumericUpDown control
        /// </summary>
        ...
        public override object Clone()
        {
            ...
            if (dataGridViewCell != null)
            {
                ...
                dataGridViewCell.LeadingSymbol = this.LeadingSymbol;
                dataGridViewCell.TrailingSymbol = this.TrailingSymbol;
        ...
        public override void DetachEditingControl()
        {
            ...
            CustomNumericUpDown numericUpDown = dataGridView.EditingControl as CustomNumericUpDown;
        ...
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            CustomNumericUpDown numericUpDown = this.DataGridView.EditingControl as CustomNumericUpDown;
            if (numericUpDown != null)
            {
                ...
                numericUpDown.LeadingSymbol = this.LeadingSymbol;
                numericUpDown.TrailingSymbol = this.TrailingSymbol;
                                      ...
                                      DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            if (!cellEdited)
            {
                if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
                {
                    ...
                    paintingNumericUpDown.LeadingSymbol = leadingSymbol;
                    paintingNumericUpDown.TrailingSymbol = trailingSymbol;
        ...
        /// Utility function that sets a new value for the LeadingSymbol property of the cell. This function is used by
        /// the cell and column LeadingSymbol property. The column uses this method instead of the LeadingSymbol
        /// property for performance reasons. This way the column can invalidate the entire column at once instead of 
        /// invalidating each cell of the column individually. A row index needs to be provided as a parameter because
        /// this cell may be shared among multiple rows.
        ...
        /// Utility function that sets a new value for the TrailingSymbol property of the cell. This function is used by
        /// the cell and column TrailingSymbol property. The column uses this method instead of the TrailingSymbol
        /// property for performance reasons. This way the column can invalidate the entire column at once instead of 
        /// invalidating each cell of the column individually. A row index needs to be provided as a parameter because
        /// this cell may be shared among multiple rows.
